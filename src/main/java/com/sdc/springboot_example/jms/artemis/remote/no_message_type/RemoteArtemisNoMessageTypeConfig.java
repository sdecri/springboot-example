...
public class RemoteArtemisNoMessageTypeConfig {
    ...
    @Bean
    public JmsTemplate artemisJmsTemplateNoMessageType() throws JMSException{
        JmsTemplate jmsTemplate = new JmsTemplate();
        jmsTemplate.setConnectionFactory(remoteActiveMQConnectionFactory());
        jmsTemplate.setPubSubDomain(true);  // enable for Pub Sub to topic. Not Required for Queue.
        jmsTemplate.setMessageConverter(treMessageConverter());
        return jmsTemplate;
    }
    ...
    public MessageConverter treMessageConverter() {
        MappingJackson2MessageConverter converter = new TreMessageConverter();
    ...
    @Bean
    public DefaultJmsListenerContainerFactory remoteArtemisJmsListenerContainerFactoryNoMessageType() throws JMSException {
